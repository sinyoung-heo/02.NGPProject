...
void CDungeon::Initialize()
{
	...
	CObjMgr::GetInstance()->AddObject(CAbstractFactory<CPotalTown>::CreateObj(773.f, 408.f),
		ObjID::EFFECT);
	CObjMgr::GetInstance()->AddObject(CAbstractFactory<CPotalDungeon>::CreateObj(1671.f, 945.f),
		ObjID::EFFECT);
